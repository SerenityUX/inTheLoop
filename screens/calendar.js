        ...
        >
          <SafeAreaView>
            <AbsenceScreen
              ...
              date={date}
              onRequestClose={() => setAbsentVisible(!absencesVisible)}
            />
          </SafeAreaView>
        </Modal>
        <SafeAreaView
          style={{ justifyContent: "space-between", height: height }}
        >
          <View>
            <Text
              style={{
            ...
            >
              Welcome Back, {route.params.name.split(" ")[0]}
            </Text>
          ...
          <View>
            <DayDisplayComponent
              ...
              setAbsentVisible={setAbsentVisible}
